      ...
      <div className="flex-row justify-between align-center mb-lg">
        ...
        <div className="flex-row gap-sm">
          <button className="btn btn-secondary">
            <span className="icon icon-filter mr-sm"></span> Filters
          </button>
          <button className="btn btn-secondary">
            <span className="icon icon-export mr-sm"></span> Export
          </button>
        </div>
      </div>
    ...
    <div className="container" style={{ paddingTop: 'var(--spacing-lg)' }}>
      ...
      <div className="flex-row justify-between align-center mb-lg">
        ...
        <div className="flex-row gap-md">
          ...
          <button className="btn btn-secondary">
            <span className="icon icon-export mr-sm"></span> Export Report
          </button>
        </div>
      </div>
